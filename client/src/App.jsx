...
import "./App.css"
import "../src/Assets/background.jpg"
...
function App() {
  ...
  useEffect(() => {
    const fetchCurrencies = async () => {
      try {
        const response = await axios.get(`${window.location.origin}/api/currencies`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${window.location.origin}/api/convert`, formData);
